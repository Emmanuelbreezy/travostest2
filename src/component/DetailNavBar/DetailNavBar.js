  ...
  return (
    <div className="p-2 mt-2">
	   	 <ul className="flex items-center justify-between text-center">
			  <li>
				  <button className="focus:outline-none" onClick={props.handler}><svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-5 pl-2 text-black fill-current cursor-pointer"  viewBox="0 0 24 24">
